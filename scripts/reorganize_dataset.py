...
def reorganize_dataset():
    ...
    # Script is in scripts/, so go up two levels to get dataset root
    ...
    # Process train split (from data/origin/train)
    train_img_dir = base_dir / "data" / "origin" / "train" / "images"
    train_label_dir = base_dir / "data" / "origin" / "train" / "labels"
    ...
    # Process val split (from data/origin/val)
    val_img_dir = base_dir / "data" / "origin" / "val" / "images"
    val_label_dir = base_dir / "data" / "origin" / "val" / "labels"
